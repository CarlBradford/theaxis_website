  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        ...
        if (storedContent?.terms_of_service) {
          setContent(storedContent.terms_of_service);
        ...
        if (legalContent?.terms_of_service) {
          setContent(legalContent.terms_of_service);
        ...
        if (fallbackContent?.terms_of_service) {
          setContent(fallbackContent.terms_of_service);
        }
      } finally {
        setLoading(false);
      }
