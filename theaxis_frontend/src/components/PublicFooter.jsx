      ...
      <div className="public-footer-container">
          ...
          <div className="public-footer-contact">
            ...
            <div className="public-footer-contact-info">
              <div className="public-footer-contact-item">
                <span>Email: theaxispub.alangilan@g.batstate-u.edu.ph</span>
              </div>
              <div className="public-footer-contact-item">
                <span>Address: Alangilan, Batangas City, Philippines</span>
              </div>
            </div>
            ...
            <div className="public-footer-social">
              ...
              <div className="public-footer-social-links">
                <a 
                  href="https://www.facebook.com/TheAXISPublications" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.instagram.com/theaxispub/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="public-footer-social-link"
        ...
        <div className="public-footer-bottom">
          <p className="public-footer-copyright">
            © 2025 The AXIS Group of Publications. All rights reserved.
          </p>
