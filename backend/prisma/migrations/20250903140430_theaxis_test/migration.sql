-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('READER', 'STAFF', 'SECTION_HEAD', 'ADMIN_ASSISTANT', 'ADVISER');

-- CreateEnum
CREATE TYPE "ArticleStatus" AS ENUM ('DRAFT', 'IN_REVIEW', 'NEEDS_REVISION', 'APPROVED', 'SCHEDULED', 'PUBLISHED', 'ARCHIVED');
...
-- CreateIndex
CREATE INDEX "EditorialNote_authorId_idx" ON "EditorialNote"("authorId");

-- CreateIndex
CREATE INDEX "EditorialNote_articleId_idx" ON "EditorialNote"("articleId");

-- CreateIndex
CREATE INDEX "EditorialNote_createdAt_idx" ON "EditorialNote"("createdAt");
...
-- AddForeignKey
ALTER TABLE "EditorialNote" ADD CONSTRAINT "EditorialNote_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
